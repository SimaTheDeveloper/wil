...
<body id="back">
    ...
    <div class="container-fluid">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#intro" class="scrollto" >Internship Wil</a></h1>
      </div>

       <nav id="nav-menu-container">
        <ul class="nav-menu">
          <li><a href="welcomestudent.php">Student Home</a></li>
          <li><a href="mainjobs.php">Accept</a></li>
          <li class="menu-active"><a href="appliedjobs.php">documents</a></li>
    ...
    <div style="text-align:center">
        <h3 >Here is The documents List</h3>
...
<div class="footer fixed-bottom">
    Get an image sharing web app in Node JS and Mongo DB for just <b>$20</b>. <a style="color: greenyellow;" href="https://adnan-tech.com/image-sharing-y-in-node-js/">Get here</a>
</div>
