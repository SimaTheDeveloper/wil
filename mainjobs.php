...
<body id="back">
      ...
      <div id="logo" class="pull-left">
       ...
       <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="mainjobs.php">wil information</a></li>
          <li><a href="appliedjobs.php">documents</a></li>
   ...
   <table style="width:100%;">
        ...
        <thead>
            <tr>
                <th style="width:10%;"><h4>Wil Id</h4></th>
                <th style="width:10%;"><h4>Company Name</h4></th>
				<th style="width:10%;"><h4>info Description</h4></th>
				<th style="width:10%;"><h4>Job Location</h4></th>
				<th style="width:10%;"><h4>info Post</h4></th>
